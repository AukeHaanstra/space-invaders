...
public record SpriteReadModel(SpriteId spriteId, boolean visible, String imagePath, boolean explosionTriggered, int x, int y, int speed,
                              Direction direction) {

    public SpriteReadModel withVisible(boolean visible) {
        return new SpriteReadModel(spriteId, visible, imagePath, explosionTriggered, x, y, speed, direction);
    }
